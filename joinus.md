...
We propose: 
- a Master 2 internship project on the [quantitative modeling of transcription dynamics in the context of DNA topology regulation](../files/2024_M2_Ivan_Junier_Quantitative_modeling.pdf).
- a Master 2 internship project on multi-omic data integration (metabolomic and lipidomic)
- a ~2y engineer position in bioinformatics and sequence analyses (soon to be advertised)
